...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h2>Welcome to the Flooring Cost Calculator</h2>
            <p>

            <form class="form-horizontal" role="form" method="post" action="flooringcalc">
                <div class="form-group">
                    <label class="col-md-4 control-label"> What's the length of your project? </label>
                    <div class="col-md-8">
                        <input type=text name="length"><br>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label"> What's the width of your project? </label>
                    <div class="col-md-8">
                        <input type=text name="width"><br>
                    </div>
                </div>
                <div class="form-group">
                    <label class ="col-md-4 control-label"> Whats the cost perSQFT or your material? </label>
                    <div class="col-md-8">
                        <input type=text name="perSqFt"><br>
                    </div>
                </div>
                <div class="form-group">
